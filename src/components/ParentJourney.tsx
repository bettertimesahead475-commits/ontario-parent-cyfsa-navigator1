...
const pageCopy: Record<Exclude<JourneyPage, "home">, { eyebrow: string; title: string; lead: string; cards: { title: string; body: string }[]; next: string; nextLabel: string }> = {
  ...
  "five-day": {
    ...
    title: "The first five days matter. Prepare for the first court hearing.",
    lead: "When section 88 applies, the CYFSA requires action as soon as practicable and in any event within five days after the child is brought to a place of safety. That is a short window to find counsel and understand a new file. Preserve the paperwork immediately, build a chronology, and use the analyzer to understand what the documents say and what questions to take to a lawyer or duty counsel.",
    cards: [
...
export default function ParentJourney({ page }: { page: JourneyPage }) {
  ...
  if (page === "home") return <div className="space-y-0">
    ...
    {/* FIRST FIVE DAYS — urgency and preparation */}
    <section className="px-6 py-14 sm:px-10 md:py-20 bg-amber-50 border-y border-amber-200">
      <div className="mx-auto max-w-5xl">
        <p className="text-xs font-black uppercase tracking-[0.2em] text-amber-800">The first five days matter</p>
        <h2 className="mt-3 max-w-4xl font-display text-3xl font-black leading-tight text-slate-950 md:text-4xl">Be prepared for the first court hearing — before the paperwork overwhelms you.</h2>
        <p className="mt-5 max-w-3xl text-base leading-relaxed text-slate-700">
          When section 88 of Ontario's CYFSA applies, the law requires action as soon as practicable and, in any event, within five days after the child is brought to a place of safety. That can leave very little time to find counsel and understand a new court file. Start organizing the documents immediately so you can use the time you do have.
        </p>
        <div className="mt-7 grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-amber-200 bg-white p-5"><p className="font-bold text-slate-900">Preserve the record</p><p className="mt-2 text-sm text-slate-600">Save the application, affidavits, notices and messages. Record the exact dates and times and build one chronology.</p></div>
          <div className="rounded-xl border border-amber-200 bg-white p-5"><p className="font-bold text-slate-900">Understand the file</p><p className="mt-2 text-sm text-slate-600">Know what is alleged, where each statement came from, what supports it, and what questions the documents raise.</p></div>
          <div className="rounded-xl border border-amber-200 bg-white p-5"><p className="font-bold text-slate-900">Prepare for court</p><p className="mt-2 text-sm text-slate-600">Take an organized timeline and focused questions to your lawyer or duty counsel. Keep building the file after the first hearing.</p></div>
        </div>
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/five-day-rule"><span className="inline-flex items-center gap-2 rounded-xl bg-amber-800 px-6 py-3 text-sm font-bold text-white">UNDERSTAND THE FIRST 5 DAYS <ArrowRight className="h-4 w-4" /></span></Link>
          <Link href="/document-analyzer"><span className="inline-flex items-center gap-2 rounded-xl border border-amber-700 bg-white px-6 py-3 text-sm font-bold text-amber-900">TRY THE ANALYZER <FileSearch className="h-4 w-4" /></span></Link>
        </div>
        <p className="mt-4 text-xs leading-relaxed text-slate-600">The statutory timing is fact-specific. Confirm how section 88 applies to your circumstances with a lawyer or duty counsel.</p>
      </div>
    </section>
    ...
    <section className="px-6 py-16 sm:px-10 md:py-20 bg-white">
      <div className="mx-auto max-w-5xl rounded-2xl border border-brand-200 bg-brand-50 p-6 md:p-8">
        <p className="text-xs font-bold uppercase tracking-widest text-brand-700">From the first documents to the finish</p>
        <h2 className="mt-3 font-display text-3xl font-black text-slate-950">Understand more than a summary. Understand the record.</h2>
        <p className="mt-4 max-w-3xl text-base leading-relaxed text-slate-700">CYFSA Navigator can help you work through chronology, allegations, source attribution, supporting records, gaps, inconsistencies, legal references and procedural questions—then turn those findings into focused questions for counsel.</p>
        <p className="mt-3 max-w-3xl text-sm leading-relaxed text-slate-600">A full redacted Form 14A analysis example will show the depth without crowding the homepage.</p>
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/document-analyzer"><span className="inline-flex items-center gap-2 rounded-xl bg-brand-700 px-6 py-3 text-sm font-bold text-white">TRY THE ANALYZER <ArrowRight className="h-4 w-4" /></span></Link>
