...
export default function AnalysisExample(){
 return <div className="mx-auto max-w-5xl space-y-8">
  <header className="rounded-3xl bg-gradient-to-br from-slate-950 via-brand-950 to-brand-800 p-7 text-white md:p-10">
   ...
   <h1 className="mt-3 font-display text-4xl font-black">Complete Form 14A analyzer report example</h1>
   <p className="mt-4 max-w-3xl leading-relaxed text-slate-200">This example is based on a <strong>real 15-page report produced by the CYFSA Document Analyzer</strong>. Identifying names, the court-file number and child/family identifiers are anonymized for this public demonstration. The analyzer's report structure, scores, findings and educational cautions are preserved.</p>
  ...
  <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
   <div className="flex gap-3"><FileText className="mt-1 h-5 w-5 text-brand-600"/><div><h2 className="font-display text-2xl font-bold">Document overview</h2><p className="mt-2 text-sm text-slate-600"><strong>Document:</strong> Affidavit (General) of CAS Manager, sworn September 30, 2025 • <strong>Type:</strong> CAS Supporting Affidavit (Form 14A) with Police Occurrence Report Exhibits • <strong>Names:</strong> anonymized for public display</p></div></div>
   <p className="mt-5 leading-relaxed text-slate-700">This analyzer report reviewed a CAS supporting affidavit together with police occurrence report exhibits. The public example below preserves the analyzer's evidence-strength, corroboration, contradiction, disclosure, statutory-threshold, procedural, Charter and verification analysis while replacing identifying information with neutral labels.</p>
  </section>

  <section className="rounded-2xl border border-slate-200 bg-white p-6"><h2 className="font-display text-2xl font-black">Actual analyzer scoring from this report</h2><div className="mt-4 flex flex-wrap items-end gap-4"><strong className="text-5xl text-brand-900">47 / 100</strong><span className="text-sm text-slate-600">Evidence Strength Index — an educational heuristic, not a legal admissibility ruling, truth determination, or legal-merits score.</span></div><div className="mt-5 grid gap-3 md:grid-cols-2 text-sm"><div className="rounded-xl bg-slate-50 p-4"><strong>Firsthand Knowledge:</strong> 4/20</div><div className="rounded-xl bg-slate-50 p-4"><strong>Source Reliability:</strong> 9/15</div><div className="rounded-xl bg-slate-50 p-4"><strong>Corroboration:</strong> 10/15</div><div className="rounded-xl bg-slate-50 p-4"><strong>Documentary Support:</strong> 11/15</div><div className="rounded-xl bg-slate-50 p-4"><strong>Internal Consistency:</strong> 6/10</div><div className="rounded-xl bg-slate-50 p-4"><strong>Contradictory Evidence Handling:</strong> 3/10</div><div className="rounded-xl bg-slate-50 p-4"><strong>Legal Authority Verification:</strong> 2/10</div><div className="rounded-xl bg-slate-50 p-4"><strong>Procedural Documentation:</strong> 2/5</div></div><p className="mt-5 text-sm leading-relaxed text-slate-700"><strong>Information Completeness: 62/100.</strong> The source report separately measures how much relevant information is contained in the reviewed document and cautions that a low score does not mean the document is false or inadmissible, while a high score does not establish legal correctness or admissibility.</p></section>
  ...
  <section className="rounded-2xl border border-amber-200 bg-amber-50 p-6"><div className="flex gap-3"><Info className="mt-1 h-5 w-5 text-amber-800"/><div><h2 className="font-display text-xl font-black">Why this public example is anonymized</h2><p className="mt-2 text-sm leading-relaxed text-amber-950">This demonstration is derived from a real analyzer-generated report, but child-protection records contain highly sensitive information. Names, the court-file number and identifying family details are therefore removed or replaced with neutral labels. Anonymization does not change the purpose of the example: showing visitors the kind of detailed output the analyzer actually produces.</p></div></div></section>
